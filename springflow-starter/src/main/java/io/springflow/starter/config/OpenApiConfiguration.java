...
public class OpenApiConfiguration {
    ...
    /**
     * Creates the SpringFlow OpenAPI customizer bean.
     * <p>
     * This customizer programmatically adds operations for dynamically
     * generated controllers to the OpenAPI specification.
     * </p>
     *
     * @return SpringFlow OpenAPI customizer instance
     */
    @Bean
    public SpringFlowOpenApiCustomizer springFlowOpenApiCustomizer() {
        log.info("Registering SpringFlow OpenAPI customizer bean");
        return new SpringFlowOpenApiCustomizer();
    }
     ...
     *
     * @param properties the SpringFlow configuration properties
     * @param customizer the SpringFlow OpenAPI customizer
    ...
    public GroupedOpenApi springFlowApi(SpringFlowProperties properties,
                                         SpringFlowOpenApiCustomizer customizer) {
